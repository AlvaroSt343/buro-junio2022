 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        notAvailableMsg     :   'No disponible hoy', // message when its not an available day or once the available hours have passed
        almostAvailableMsg  :   'Estar¨¦ disponible pronto', // if today is an available day and before the time starts
        defaultMsg          :   '{{url}}  -  Hola! Solicito informacion sobre:', // default support msg     
